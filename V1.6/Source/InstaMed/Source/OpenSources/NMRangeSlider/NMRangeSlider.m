...
//    self.track.autoresizingMask = UIViewAutoresizingFlexibleWidth;
...
//    self.trackBackground.translatesAutoresizingMaskIntoConstraints = NO;
//    
//    self.trackBackground.autoresizingMask = UIViewAutoresizingFlexibleWidth;
